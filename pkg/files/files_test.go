...
import (
	...
	filehelpers "github.com/jenkins-x/jx-helpers/pkg/files"
...
func TestGlobFiles(t *testing.T) {
	...
	*/
	err := filehelpers.GlobAllFiles("", "test_data/glob_test/*", fn)
	require.NoError(t, err)
...
func TestToValidFileSystemName(t *testing.T) {
	assert.Equal(t, filehelpers.ToValidFileSystemName("x.y/z"), "x_y_z")
}

func Test_FileExists_for_non_existing_file_returns_false(t *testing.T) {
	exists, err := filehelpers.FileExists("/foo/bar")
