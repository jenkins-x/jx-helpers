...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-helpers/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-helpers:3.0.130'
